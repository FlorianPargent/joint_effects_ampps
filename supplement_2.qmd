...
To keep our example as simple as possible, we again make the unlikely assumption that $U$ does not affect $A_2$.
...
For our hypothetical RCT, we need different statistical models to estimate our total, joint, and direct effects:
