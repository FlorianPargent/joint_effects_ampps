...
Note that the total, joint effects, and the  are estimated without bias, while the direct effects are biased because of the unobserved confounder U (except for the direct effect of "late use", which for our data generating process is equal to the joint effect of "late use").
